                        ...
                        <div class="modal-body">
                            ...
                            <form action="user?action=register" method="POST">
                                <div class="ms_register_form">
                                    ...
                                    <div class="form-group">
                                        <input type="password" placeholder="Confirm Password" name="repass" class="form-control">
                                        <span class="form_icon">
                                            <i class=" fa_icon form-lock" aria-hidden="true"></i>
                                        </span>
                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="user?action=login" method="POST">
                                <div class="ms_register_form">
                                    <h2>login / Sign in</h2>
                                    <h3 style="color: red; align-content: center">${error}</h3>
                                    <div class="form-group">
                                        <input type="text" placeholder="Enter Your Email" name="email" value="${cookie.user_email.value}" class="form-control">
                                        <span class="form_icon">
                                            <i class="fa_icon form-envelope" aria-hidden="true"></i>
                                        </span>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" placeholder="Enter Password" value="${cookie.user_pass.value}" name="pass" class="form-control">
                                        <span class="form_icon">
                                            <i class="fa_icon form-lock" aria-hidden="true"></i>
                                        </span>
                                    </div>
