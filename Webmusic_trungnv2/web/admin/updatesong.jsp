                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="update" method="POST">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">ID_Song <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                ${requestScope.songs.id_song}<input type="hidden" class="form-control" id="val-username" name="id_song" value="${requestScope.songs.id_song}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="name" value="${requestScope.songs.name}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="description" value="${requestScope.songs.description}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <c:forEach items="${requestScope.allsingers}" var="s">
                                                        <input type="checkbox" 
                                                               <c:forEach items="${requestScope.songs.singers}" var="ch">
                                                                       <c:if test="${ch.id_singer eq s.id_singer}">
                                                               checked="checked"
                                                               </c:if>
                                                                    </c:forEach>
                                                                    name="id_singer" value="${s.id_singer}" /> ${s.name}
                                                        </c:forEach>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <c:forEach items="${requestScope.allgenres}" var="g">
                                                        <input type="checkbox" 
                                                               <c:forEach items="${requestScope.songs.genres}" var="ges">
                                                                       <c:if test="${ges.id_genre==g.id_genre}">
                                                               checked="checked"
                                                               </c:if>
                                                                    </c:forEach>
                                                                    name="id_genre" value="${g.id_genre}" /> ${g.name_genre}
                                                        </c:forEach>
                                            </div>
                                        </div>
